				...
				<table width="1000" border="1" align="center" class="table table-striped table-bordered table-hover">
				  <tr>
					<td><table width="100%" border="1" class="table table-striped table-bordered table-hover">
					  <tr>
						<td colspan="7" style="text-align: center;background-color: #123751;color: white">DANH SÁCH LOẠI TIN</td>
						</tr>
					  <tr>
						<td>idLT</td>
						<td>Ten</td>
					  ...
					  <tr>
						...
						<td>{AnHien}</td>
						<td>{TenTL}</td>
						<td><a href="suaLoaiTin.php?idLT={idLT}">Sửa</a> - <a onclick = "return confirm('Bạn có chắc là muốn xoá loại tin')" href="xoaLoaiTin.php?idLT={idLT}">Xoá</a></td>
					  </tr>
